...
func SwitchClasses(p SwitchProps) string {
	return uiutils.Compose(SwitchVariants, map[string]string{
		"variant": p.Variant,
		"size":    p.Size,
	}, p.Class)
}
...
func Switch(p SwitchProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/switch/switch.templ`, Line: 40, Col: 12}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `ui/switch/switch.templ`, Line: 43, Col: 15}
		}
