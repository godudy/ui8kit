...
func toneSurface(tone string) string {
...
func homeMenuButtonProps() ui.ButtonProps {
	return ui.ButtonProps{
		...
		Attrs: templpkg.Attributes{
			...
			"data-ui8kit-dialog-target": homeSheetPanelID,
			"aria-haspopup":             "dialog",
			"aria-controls":             homeSheetPanelID,
			"aria-expanded":             "false",
		},
	}
}

func homeSheetRootProps() ui.BoxProps {
	return ui.BoxProps{
...
func homeSheetOverlayProps() ui.BoxProps {
	return ui.BoxProps{
...
func homeSheetCloseButtonProps() ui.ButtonProps {
	return ui.ButtonProps{
		Variant:   "outline",
		Size:      "icon",
